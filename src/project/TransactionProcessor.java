...
public class TransactionProcessor implements TransactionProcessorInterface {
	...
	private DataBaseDAOInterface db_dao_Interface;

	public TransactionProcessor(DataBaseDAOInterface db_dao_Interface) {
	...
	public boolean AddPenality(String name, double penality) {
		...
		if (client != null) {
			if (client.getAccountBalance() >= penality && penality>0) {
